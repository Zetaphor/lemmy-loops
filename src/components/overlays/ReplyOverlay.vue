      ...
      <div class="pl-1">
        <div class="inline-flex items-center">
          ...
          <div class="avatar mr-0.5"
            v-if="replyOverlay.data.creator_avatar.length && preferences.showPostAvatars && preferences.showPostCustomAvatars">
            <div class="w-4 rounded-full mr-0.5">
              <img :src="replyOverlay.data.creator_avatar"
                :alt="`${replyOverlay.data.creator_name}@${replyOverlay.data.creator_actor_domain}`"
                :title="`${replyOverlay.data.creator_name}@${replyOverlay.data.creator_actor_domain}`" />
            </div>
          </div>
          ...
          <div v-else-if="preferences.showPostAvatars" class="mr-0.5">
            <Avatar :size="16" variant="beam"
              :name="`${replyOverlay.data.creator_name}@${replyOverlay.data.creator_actor_domain}`" />
          </div>
          ...
          <p class="text-sm flex-grow-0 ml-0.5">
            <span class="text-gray-300 text-md">{{ replyOverlay.data.creator_name }}</span>
            <span class="text-gray-400 text-md">@{{ replyOverlay.data.creator_actor_domain }}</span>
          </p>
        </div>
      </div>
