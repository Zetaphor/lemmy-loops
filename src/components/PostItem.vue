  ...
  <div class="relative overflow-y-hidden overflow-x-auto snap-x scrollbar-hide snap-mandatory">
    ...
    <div class="w-full h-full absolute snap-start left-full">
      <div class="flex h-full justify-center items-center">
        <div class="flex">
          <div class="flex-1">
            <svg v-if="props.post.counts.my_vote === 1" xmlns="http://www.w3.org/2000/svg" viewBox="10 0 70 90"
          ...
          <div class="flex-1">
            <svg v-if="props.post.counts.my_vote === -1" xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="flex-1">
            <svg v-if="props.post.content.saved" viewBox="10 -5 75 100"
              class="stroke-yellow-300 fill-yellow-300 w-16 h-16 p-3" xmlns="http://www.w3.org/2000/svg">
              <path
            ...
            <p class="text-center w-full">Save<span v-if="props.post.content.saved">d</span></p>
          </div>
          <div class="flex-1">
    ...
    <div class="w-full relative snap-start">
      <div class="card-bordered card-compact my-2 shadow-sm cursor-pointer flex w-full"
        :class="[props.post.content.read ? 'bg-neutral-800' : 'bg-gray-800']">
        <div
          ...
          <div class="p-2">
            ...
            <div>
              <div class="text-xs inline-flex items-center text-gray-500">
                ...
                <p class="flex-grow-0 text-md">{{ props.post.content.published }}</p>

                <p class="flex-grow-0 text-md ml-3">{{ props.post.counts.score }}pts</p>
